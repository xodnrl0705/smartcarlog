...
public class CarDriving {
	...
	private String accStep;
	private String brkStep;
	private String wheelStep;
	private String dirLightStep;
	private String areaNum;
	private int areaTypeNum;
	private int speed = 0;
	private boolean isAdd = false;

	public CarDriving(String carNum, boolean isAdd, int areaTypeNum){
		this.carNum = carNum;
		this.isAdd = isAdd;
	...
	public String getWheelStep() {
		...
		if(dirPrefix.equals("F")){
			this.dirLightStep = "N";
		} else if(dirPrefix.equals("L")){
			this.dirLightStep = "L";
		} else if(dirPrefix.equals("R")){
			this.dirLightStep = "R";
		}
